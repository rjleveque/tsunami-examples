...
#------------------------------
    ...
    clawdata.upper[1] = 57.0          # yupper

    # Number of grid cells:
    clawdata.num_cells[0] = 35      # mx
    clawdata.num_cells[1] = 24      # my
    ...
    clawdata.num_eqn = 3 # 3 for SWE, 5 for Bouss
    ...
    if 0:
        # tracking main wave:
        regions.append([1, 4, 0., 3.*3600., 152., 175., 30., 57.])
        regions.append([1, 4, 3.*3600., 6*3600., 165., 200., 20., 42.])
    ...
    # set sphere_source=0 to omit source terms for sphere, 
    # as in v5.9.2 and earlier.  The default is now 1.
